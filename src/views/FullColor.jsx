                    ...
                    <div style={{display: 'flex', alignItems: 'center', gap: '40px', marginBottom: '20px', width: '100%'}}>
                        ...
                        <div style={{position: 'relative', minWidth: '450px', height: '300px'}}>
                            ...
                            <img 
                                ...
                                style={{width: '220px', height: '140px', objectFit: 'cover', borderRadius: '8px', boxShadow: '0 6px 12px rgba(0,0,0,0.3)', position: 'absolute', top: '30px', left: '30px', transform: 'rotate(-8deg)'}}
                            />
                            <img 
                                ...
                                style={{width: '220px', height: '140px', objectFit: 'cover', borderRadius: '8px', boxShadow: '0 6px 12px rgba(0,0,0,0.3)', position: 'absolute', top: '60px', left: '80px', transform: 'rotate(6deg)'}}
                            />
                            <img 
                                ...
                                style={{width: '220px', height: '140px', objectFit: 'cover', borderRadius: '8px', boxShadow: '0 6px 12px rgba(0,0,0,0.3)', position: 'absolute', top: '90px', left: '130px', transform: 'rotate(-12deg)'}}
                            />
                            <img 
                                ...
                                style={{width: '220px', height: '140px', objectFit: 'cover', borderRadius: '8px', boxShadow: '0 6px 12px rgba(0,0,0,0.3)', position: 'absolute', top: '120px', left: '180px', transform: 'rotate(10deg)'}}
                            />
                        </div>
                    </div>
                </div>
