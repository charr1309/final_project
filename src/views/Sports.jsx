                    ...
                    <div style={{display: 'flex', alignItems: 'center', gap: '40px', marginBottom: '20px', width: '100%'}}>
                        ...
                        <div style={{position: 'relative', minWidth: '450px', height: '300px'}}>
                            ...
                            <img 
                                ...
                                style={{width: '280px', height: '180px', objectFit: 'cover', borderRadius: '8px', boxShadow: '0 6px 12px rgba(0,0,0,0.3)', position: 'absolute', top: '20px', left: '20px', transform: 'rotate(-3deg)'}}
                            />
                            <img 
                                ...
                                style={{width: '280px', height: '180px', objectFit: 'cover', borderRadius: '8px', boxShadow: '0 6px 12px rgba(0,0,0,0.3)', position: 'absolute', top: '35px', left: '35px', transform: 'rotate(2deg)'}}
                            />
                            <img 
                                ...
                                style={{width: '280px', height: '180px', objectFit: 'cover', borderRadius: '8px', boxShadow: '0 6px 12px rgba(0,0,0,0.3)', position: 'absolute', top: '50px', left: '50px', transform: 'rotate(-1deg)'}}
                            />
                            <img 
                                ...
                                style={{width: '280px', height: '180px', objectFit: 'cover', borderRadius: '8px', boxShadow: '0 6px 12px rgba(0,0,0,0.3)', position: 'absolute', top: '65px', left: '65px', transform: 'rotate(4deg)'}}
                            />
                        </div>
                    </div>
                </div>
