                ...
                <div>
                    ...
                    <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '60px', marginBottom: '20px', width: '100%', maxWidth: '1200px', margin: '0 auto'}}>
                        ...
                        <div style={{position: 'relative', minWidth: '500px', height: '350px'}}>
                            {/* Spread layout */}
                            <img 
                                src="https://images.pexels.com/photos/6205509/pexels-photo-6205509.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&dpr=1" 
                            ...
                            />
                            <img 
                                src="https://images.pexels.com/photos/6801642/pexels-photo-6801642.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&dpr=1" 
                            ...
                            />
                            <img 
                                src="https://images.pexels.com/photos/6801641/pexels-photo-6801641.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&dpr=1" 
                            ...
                            />
                            <img 
                                src="https://images.pexels.com/photos/6801640/pexels-photo-6801640.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&dpr=1" 
