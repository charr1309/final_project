                    ...
                    <div style={{display: 'flex', alignItems: 'center', gap: '40px', marginBottom: '20px', width: '100%'}}>
                        ...
                        <div style={{position: 'relative', minWidth: '450px', height: '300px'}}>
                            ...
                            <img 
                                ...
                                style={{width: '180px', height: '120px', objectFit: 'cover', borderRadius: '8px', boxShadow: '0 6px 12px rgba(0,0,0,0.3)', position: 'absolute', top: '40px', left: '20px', transform: 'rotate(-20deg)'}}
                            />
                            <img 
                                ...
                                style={{width: '180px', height: '120px', objectFit: 'cover', borderRadius: '8px', boxShadow: '0 6px 12px rgba(0,0,0,0.3)', position: 'absolute', top: '60px', left: '100px', transform: 'rotate(-5deg)'}}
                            />
                            <img 
                                ...
                                style={{width: '180px', height: '120px', objectFit: 'cover', borderRadius: '8px', boxShadow: '0 6px 12px rgba(0,0,0,0.3)', position: 'absolute', top: '80px', left: '180px', transform: 'rotate(10deg)'}}
                            />
                            <img 
                                ...
                                style={{width: '180px', height: '120px', objectFit: 'cover', borderRadius: '8px', boxShadow: '0 6px 12px rgba(0,0,0,0.3)', position: 'absolute', top: '100px', left: '260px', transform: 'rotate(25deg)'}}
                            />
                        </div>
                    </div>
                </div>
