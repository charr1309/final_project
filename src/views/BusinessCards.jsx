                ...
                <div>
                    ...
                    <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '60px', marginBottom: '20px', width: '100%', maxWidth: '1200px', margin: '0 auto'}}>
                        ...
                        <div style={{position: 'relative', minWidth: '500px', height: '350px'}}>
                            ...
                            />
                            <img 
                                src="https://images.pexels.com/photos/6205508/pexels-photo-6205508.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&dpr=1" 
                            ...
                            />
                            <img 
                                src="https://images.pexels.com/photos/6205507/pexels-photo-6205507.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&dpr=1" 
                            ...
                            />
                            <img 
                                src="https://images.pexels.com/photos/6205506/pexels-photo-6205506.jpeg?auto=compress&cs=tinysrgb&w=400&h=250&dpr=1" 
